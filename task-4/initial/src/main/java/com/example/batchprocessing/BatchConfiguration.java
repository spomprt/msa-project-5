...
public class BatchConfiguration {
    ...
    public JdbcBatchItemWriter<Product> productWriter(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Product>()
                ...
                .sql("INSERT INTO products (productId, productSku, productName, productAmount, productData) VALUES (:productId, :productSku, :productName, :productAmount, :productData)")
    ...
    public JdbcBatchItemWriter<Loyality> loyaltyWriter(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Loyality>()
                .itemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider<>())
                .sql("INSERT INTO loyality_data (productSku, loyalityData) VALUES (:productSku, :loyalityData)")
                .dataSource(dataSource)
                .build();
    }
